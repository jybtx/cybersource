...
//        $request->merchantReferenceCode = $merchantReferenceCode;
        $request->merchantReferenceCode = $this->getReferenceCode();
     ...
     */
    public function runTransactionFromXml($xml)
    {
     ...
     * @return stdClass An object representation of the transaction response.
     */
    public function runTransactionFromFile($filePath)
    {
        $request = $this->createRequest();
        $xml     = file_get_contents($filePath);
        return $this->runTransactionFromXml($xml);
    }
}